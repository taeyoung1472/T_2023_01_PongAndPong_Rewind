...
public class Analysis : MonoBehaviour
{
    ...
    private void SetUp()
    {
        ...
        seq.Insert(1f, DOTween.To(() => ¸àÁê¹Þ¾Ò¾î.Color, x => ¸àÁê¹Þ¾Ò¾î.Color = x, new Color(1, 0.4f, 0), 1f));
        ...
        seq.Join(DOTween.To(() => inner.AngRadiansEnd, x => inner.AngRadiansEnd = x, 450 * Mathf.Deg2Rad, 1f));
